...
export const WavyHeader = ({ headerIllustration, ...props }: WavyHeaderProps) => {
  const Comp = IllustrationSVG(headerIllustration ?? Illustrations.AleciaWave)
      ...
      <div className={cn('flex items-center justify-items-center px-8 md:px-20 page-container')}>
        ...
        >
          ...
          <div className="col-span-1 relative h-full z-[100] -mb-[150px]">
            <Comp className="w-[90%] max-w-[300px] md:max-w-full z-[100] mx-auto md:absolute md:top-0 md:right-0" />
          </div>
        </div>
      </div>
    </header>
