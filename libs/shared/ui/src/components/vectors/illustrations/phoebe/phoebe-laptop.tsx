...
export const PhoebeLaptopIllustration: FC<VectorProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 710 472" {...props}>
    <title>Phoebe, the cat, typing an email on a laptop</title>
    <defs>
      <image
        width={143}
        height={144}
        id="phoebe-laptop-logo-light"
      ...
      />
      <radialGradient
        id="phoebe-laptop-light"
        cx={0}
        cy={0}
        r={1}
        gradientUnits="userSpaceOnUse"
        gradientTransform="matrix(289.996,-278.996,278.996,289.996,143.998,355)"
      >
        <stop offset={0} stopColor="#ffebb7" stopOpacity={1} />
        <stop offset={0.954} stopColor="#ffffff" stopOpacity={0} />
      </radialGradient>
    </defs>
    <g id="phoebe-laptop-svg">
      <g id="darck illustration">
        <g>
          <g>
            <path
              className="fill-primary-300"
              d="m272.4 21.6h-191.4c-11.8 0-21.5 9.6-21.5 21.5v125c0 11.9 9.7 21.5 21.5 21.5h72.6c0 0 22.7 22.1 23.4 22.8l22.8-22.8h72.6c11.9 0 21.5-9.6 21.5-21.5v-125c0-11.9-9.6-21.5-21.5-21.5z"
            />
          </g>
          <g>
            <path className="cat-face-outline" d="m85.1 60v-1.4h10v1.4h-4.2v12.3h-1.6v-12.3z" />
            <path
              fillRule="evenodd"
              className="cat-face-outline"
              d="m94.9 67.2q0-2.3 1.6-3.8 1.5-1.5 3.8-1.5 2.3 0 3.8 1.5 1.5 1.5 1.5 3.8 0 2.3-1.5 3.8-1.5 1.6-3.8 1.6-1.6 0-2.8-0.7-1.2-0.7-1.9-1.9-0.7-1.2-0.7-2.8zm1.6 0q0 1.7 1.1 2.9 1 1.1 2.7 1.1 1.6 0 2.7-1.2 1-1.1 1-2.8 0-1.7-1-2.8-1.1-1.1-2.7-1.1-1.7 0-2.7 1.1-1.1 1.1-1.1 2.8z"
            />
            <path
              className="cat-face-outline"
              d="m108.5 64.6q-0.4-0.3-0.4-0.8 0-0.4 0.4-0.8 0.3-0.3 0.8-0.3 0.4 0 0.8 0.3 0.3 0.4 0.3 0.8 0 0.5-0.3 0.8-0.4 0.4-0.8 0.4-0.5 0-0.8-0.4zm0 7.6q-0.4-0.3-0.4-0.8 0-0.4 0.4-0.8 0.3-0.3 0.8-0.3 0.4 0 0.8 0.3 0.3 0.4 0.3 0.8 0 0.5-0.3 0.8-0.4 0.4-0.8 0.4-0.5 0-0.8-0.4z"
            />
            <path
              className="cat-face-outline"
              d="m119.2 72.3v-14.7h1.5v6h0.2q0.3-0.7 1.1-1.2 0.9-0.5 2-0.5 1.8 0 2.8 1.1 1.1 1.2 1.1 2.9v6.4h-1.6v-6.3q0-1.2-0.8-1.9-0.7-0.8-1.9-0.8-1.2 0-2 0.8-0.9 0.8-0.9 2v6.2z"
            />
            <path
              fillRule="evenodd"
              className="cat-face-outline"
              d="m130.4 67.2q0-1.2 0.4-2.2 0.4-1 1.1-1.7 0.6-0.7 1.6-1.1 0.9-0.3 1.9-0.3 1.5 0 2.7 0.6 1.1 0.7 1.7 1.9 0.6 1.2 0.6 2.7v0.7h-8.3q0 1.5 1 2.4 0.9 1 2.5 1 1 0 1.9-0.5 0.8-0.5 1.2-1.4h1.6q-0.5 1.5-1.7 2.4-1.3 0.9-3.1 0.9-1.5 0-2.7-0.7-1.1-0.7-1.8-1.9-0.6-1.3-0.6-2.8zm1.7-0.8h6.6q-0.1-1.5-1-2.3-0.9-0.8-2.3-0.8-1.3 0-2.2 0.8-1 0.9-1.1 2.3z"
            />
            <path
              className="cat-face-outline"
              d="m142.5 70.1v-12.5h1.6v12.5q0 0.4 0.2 0.6 0.2 0.2 0.5 0.2h0.5v1.4h-0.8q-0.9 0-1.4-0.6-0.6-0.5-0.6-1.6z"
            />
            <path
              className="cat-face-outline"
              d="m147.9 70.1v-12.5h1.6v12.5q0 0.4 0.2 0.6 0.2 0.2 0.5 0.2h0.5v1.4h-0.7q-1 0-1.5-0.6-0.6-0.5-0.6-1.6z"
            />
            <path
              fillRule="evenodd"
              className="cat-face-outline"
              d="m152.5 67.2q0-2.3 1.5-3.8 1.5-1.5 3.8-1.5 2.3 0 3.8 1.5 1.5 1.5 1.5 3.8 0 2.3-1.5 3.8-1.5 1.6-3.8 1.6-1.5 0-2.8-0.7-1.2-0.7-1.9-1.9-0.6-1.2-0.6-2.8zm1.5 0q0 1.7 1.1 2.9 1 1.1 2.7 1.1 1.6 0 2.7-1.2 1-1.1 1-2.8 0-1.7-1-2.8-1.1-1.1-2.7-1.1-1.7 0-2.7 1.1-1.1 1.1-1.1 2.8z"
            />
            <path
              fillRule="evenodd"
              className="cat-face-outline"
              d="m165.1 67.2q0-1.7 0.6-3.2 0.6-1.5 1.7-2.6 1.1-1.1 2.6-1.7 1.6-0.6 3.3-0.6 1.7 0 3.2 0.5 1.5 0.6 2.5 1.6 1.1 1 1.6 2.4 0.6 1.3 0.6 2.8 0 2.3-0.8 3.5-0.9 1.2-2.3 1.2-0.9 0-1.5-0.4-0.5-0.4-0.7-1.1h-0.2q-0.2 0.6-0.9 1-0.7 0.5-1.7 0.5-1.7 0-2.7-1.1-1.1-1-1.1-2.8 0-1.7 1-2.8 1.1-1.1 2.7-1.1 0.9 0 1.5 0.4 0.6 0.3 0.9 0.8h0.1v-1.1h1.3v5.1q0 0.7 0.4 1 0.3 0.4 1 0.4 1.8 0 1.8-3.5 0-1.2-0.5-2.4-0.5-1.1-1.4-2-0.8-0.8-2.1-1.3-1.3-0.5-2.7-0.5-1.5 0-2.8 0.6-1.2 0.5-2.1 1.5-0.9 0.9-1.4 2.2-0.5 1.2-0.5 2.6 0 1.5 0.5 2.7 0.5 1.3 1.4 2.1 0.9 0.9 2.2 1.4 1.4 0.6 2.9 0.6h3.3v1.3h-3.3q-2.4 0-4.3-1.1-1.9-1-3-2.8-1.1-1.9-1.1-4.1zm5.6 0q0 1.2 0.7 2 0.7 0.7 1.8 0.7 1 0 1.7-0.7 0.7-0.7 0.7-2 0-1.2-0.7-1.9-0.7-0.7-1.8-0.7-1 0-1.7 0.7-0.7 0.7-0.7 1.9z"
            />
            <path
              fillRule="evenodd"
              className="cat-face-outline"
              d="m183 67.2q0-2.3 1.4-3.8 1.4-1.5 3.6-1.5 0.7 0 1.4 0.2 0.6 0.2 1.1 0.5 0.4 0.4 0.7 0.6 0.2 0.3 0.4 0.6h0.1v-1.7h1.5v10.2h-1.4v-1.6h-0.2q-1.3 1.9-3.5 1.9-2.2 0-3.7-1.5-1.4-1.5-1.4-3.9zm1.6 0q0 1.8 1 2.9 1 1.1 2.6 1.1 1.6 0 2.6-1.2 1-1.1 1-2.8 0-1.8-1.1-2.9-1-1-2.5-1-1.6 0-2.6 1.1-1 1.1-1 2.8z"
            />
            <path
              className="cat-face-outline"
              d="m196.6 70.1v-12.5h1.5v12.5q0 0.4 0.2 0.6 0.2 0.2 0.6 0.2h0.4v1.4h-0.7q-1 0-1.5-0.6-0.5-0.5-0.5-1.6z"
            />
            <path
              fillRule="evenodd"
              className="cat-face-outline"
              d="m201.1 67.2q0-1.2 0.4-2.2 0.4-1 1.1-1.7 0.6-0.7 1.6-1.1 0.9-0.3 1.9-0.3 1.5 0 2.7 0.6 1.1 0.7 1.7 1.9 0.6 1.2 0.6 2.7v0.7h-8.4q0.1 1.5 1 2.4 1 1 2.5 1 1.1 0 2-0.5 0.8-0.5 1.2-1.4h1.6q-0.5 1.5-1.7 2.4-1.3 0.9-3.1 0.9-1.5 0-2.7-0.7-1.1-0.7-1.8-1.9-0.6-1.3-0.6-2.8zm1.7-0.8h6.6q-0.1-1.5-1-2.3-0.9-0.8-2.3-0.8-1.3 0-2.2 0.8-1 0.9-1.1 2.3z"
            />
            <path
              className="cat-face-outline"
              d="m213.7 69.9q-0.7-1.2-0.7-2.7 0-1.5 0.7-2.7 0.7-1.2 1.9-1.9 1.1-0.7 2.6-0.7 1.7 0 3.1 0.9 1.4 1 1.8 2.7h-1.7q-0.3-1-1.1-1.6-0.9-0.6-2-0.6-1.7 0-2.7 1.1-1 1.1-1 2.8 0 1.7 1 2.9 1.1 1.1 2.7 1.1 1.1 0 2-0.6 0.9-0.6 1.2-1.6h1.6q-0.4 1.6-1.8 2.6-1.3 1-3.1 1-1.5 0-2.7-0.7-1.2-0.7-1.8-2z"
            />
            <path
              className="cat-face-outline"
              d="m225.5 59.1q0-0.4 0.3-0.8 0.3-0.3 0.8-0.3 0.5 0 0.9 0.3 0.3 0.4 0.3 0.8 0 0.5-0.3 0.8-0.4 0.4-0.9 0.4-0.5 0-0.8-0.4-0.3-0.3-0.3-0.8zm0.3 13.2v-10.2h1.6v10.2z"
            />
            <path
              fillRule="evenodd"
              className="cat-face-outline"
              d="m229.9 67.2q0-2.3 1.4-3.8 1.4-1.5 3.6-1.5 0.7 0 1.4 0.2 0.7 0.2 1.1 0.5 0.4 0.4 0.7 0.6 0.2 0.3 0.4 0.6h0.1v-1.7h1.5v10.2h-1.4v-1.6h-0.2q-1.3 1.9-3.5 1.9-2.2 0-3.7-1.5-1.4-1.5-1.4-3.9zm1.6 0q0 1.8 1 2.9 1 1.1 2.6 1.1 1.6 0 2.6-1.2 1-1.1 1-2.8 0-1.8-1.1-2.9-1-1-2.5-1-1.6 0-2.6 1.1-1 1.1-1 2.8z"
            />
            <path
              className="cat-face-outline"
              d="m243.6 72.2q-0.3-0.3-0.3-0.8 0-0.4 0.3-0.8 0.4-0.3 0.8-0.3 0.5 0 0.8 0.3 0.3 0.4 0.3 0.8 0 0.5-0.3 0.8-0.3 0.4-0.8 0.4-0.4 0-0.8-0.4z"
            />
            <path
              className="cat-face-outline"
              d="m248.7 69.9q-0.6-1.2-0.6-2.7 0-1.5 0.6-2.7 0.7-1.2 1.9-1.9 1.2-0.7 2.7-0.7 1.7 0 3 0.9 1.4 1 1.8 2.7h-1.6q-0.3-1-1.2-1.6-0.9-0.6-2-0.6-1.6 0-2.6 1.1-1.1 1.1-1.1 2.8 0 1.7 1.1 2.9 1 1.1 2.6 1.1 1.2 0 2-0.6 0.9-0.6 1.2-1.6h1.6q-0.4 1.6-1.7 2.6-1.4 1-3.1 1-1.5 0-2.7-0.7-1.2-0.7-1.9-2z"
            />
            <path
              fillRule="evenodd"
              className="cat-face-outline"
              d="m260.1 67.2q0-2.3 1.4-3.8 1.4-1.5 3.6-1.5 0.7 0 1.4 0.2 0.6 0.2 1 0.5 0.5 0.4 0.7 0.6 0.3 0.3 0.4 0.6h0.2v-1.7h1.5v10.2h-1.5v-1.6h-0.1q-1.3 1.9-3.5 1.9-2.3 0-3.7-1.5-1.4-1.5-1.4-3.9zm1.6 0q0 1.8 1 2.9 1 1.1 2.6 1.1 1.6 0 2.5-1.2 1-1.1 1-2.8 0-1.8-1-2.9-1-1-2.6-1-1.5 0-2.5 1.1-1 1.1-1 2.8z"
            />
            <path
              className="cat-face-outline"
              d="m85.4 91.8h1.6q0 1.2 0.9 2 1 0.9 2.5 0.9 1.4 0 2.2-0.7 0.9-0.6 0.9-1.7 0-0.6-0.3-1.1-0.2-0.5-0.7-0.8-0.4-0.3-1-0.5-0.5-0.2-1.2-0.4-0.6-0.1-1.2-0.3-0.7-0.1-1.2-0.4-0.6-0.3-1-0.7-0.5-0.4-0.7-1-0.3-0.7-0.3-1.5 0-1.6 1.2-2.6 1.2-1.1 3.2-1.1 0.8 0 1.6 0.2 0.7 0.2 1.4 0.7 0.7 0.5 1.1 1.3 0.4 0.8 0.4 1.8h-1.6q0-1.2-0.8-1.9-0.8-0.7-2.1-0.7-1.4 0-2.1 0.7-0.7 0.7-0.7 1.6 0 0.6 0.3 1 0.2 0.5 0.6 0.7 0.5 0.3 1.1 0.5 0.5 0.1 1.2 0.3 0.6 0.2 1.2 0.4 0.6 0.1 1.2 0.4 0.6 0.3 1 0.7 0.5 0.4 0.7 1.1 0.3 0.7 0.3 1.6 0 1.6-1.3 2.7-1.3 1.1-3.5 1.1-1.3 0-2.4-0.5-1.2-0.6-1.8-1.6-0.7-1-0.7-2.2z"
            />
            <path
              className="cat-face-outline"
              d="m97.7 92.1v-6.4h1.5v6.3q0 1.2 0.8 2 0.7 0.7 1.8 0.7 1.3 0 2.1-0.8 0.8-0.9 0.8-2.1v-6.1h1.6v10.2h-1.6v-1.5h-0.1q-0.3 0.7-1.2 1.2-0.8 0.5-1.9 0.5-1.8 0-2.8-1.1-1-1.2-1-2.9z"
            />
            <path
              fillRule="evenodd"
              className="cat-face-outline"
              d="m109.6 95.9v-14.7h1.5v6.1h0.1q0.2-0.2 0.5-0.5 0.2-0.3 0.6-0.6 0.5-0.4 1.1-0.6 0.7-0.2 1.4-0.2 2.2 0 3.6 1.5 1.4 1.5 1.4 3.9 0 2.3-1.4 3.8-1.4 1.5-3.7 1.5-0.6 0-1.2-0.1-0.5-0.2-0.9-0.4-0.4-0.2-0.7-0.5-0.3-0.3-0.5-0.5-0.1-0.2-0.2-0.4h-0.1v1.7zm1.5-5.1q0 1.6 0.9 2.8 1 1.1 2.6 1.1 1.6 0 2.6-1.1 1-1 1-2.8 0-1.8-1-2.9-1-1.1-2.5-1.1-1.6 0-2.6 1.1-1 1.1-1 2.9z"
            />
            <path
              className="cat-face-outline"
              d="m119.9 99h0.8q0.9 0 1.4-0.6 0.5-0.5 0.5-1.3v-11.4h1.5v11.4q0 1.5-0.9 2.4-1 0.9-2.6 0.9h-0.7zm2.3-16.3q0-0.5 0.3-0.8 0.4-0.3 0.9-0.3 0.5 0 0.8 0.3 0.3 0.3 0.3 0.8 0 0.5-0.3 0.8-0.3 0.3-0.8 0.3-0.5 0-0.9-0.3-0.3-0.3-0.3-0.8z"
            />
            <path
              fillRule="evenodd"
              className="cat-face-outline"
              d="m127 90.8q0-1.2 0.4-2.2 0.4-1 1.1-1.7 0.7-0.7 1.6-1.1 0.9-0.4 1.9-0.4 1.6 0 2.7 0.7 1.1 0.7 1.7 1.9 0.6 1.2 0.6 2.6v0.7h-8.3q0 1.6 1 2.5 0.9 0.9 2.5 0.9 1 0 1.9-0.5 0.9-0.5 1.2-1.3h1.6q-0.4 1.4-1.7 2.3-1.3 0.9-3 0.9-1.6 0-2.7-0.7-1.2-0.7-1.8-1.9-0.7-1.2-0.7-2.7zm1.7-0.9h6.7q-0.1-1.4-1.1-2.3-0.9-0.8-2.2-0.8-1.3 0-2.3 0.9-1 0.9-1.1 2.2z"
            />
            <path
              className="cat-face-outline"
              d="m139.6 93.5q-0.7-1.2-0.7-2.7 0-1.5 0.7-2.7 0.7-1.3 1.9-2 1.2-0.7 2.7-0.7 1.7 0 3 1 1.4 1 1.8 2.6h-1.6q-0.3-1-1.2-1.6-0.9-0.6-2-0.6-1.6 0-2.6 1.2-1.1 1.1-1.1 2.8 0 1.7 1.1 2.8 1 1.1 2.6 1.1 1.2 0 2-0.6 0.9-0.6 1.2-1.6h1.6q-0.4 1.7-1.7 2.7-1.4 0.9-3.1 0.9-1.5 0-2.7-0.7-1.2-0.7-1.9-1.9z"
            />
            <path
              className="cat-face-outline"
              d="m150.8 87v-1.3h1.5q0.2 0 0.4-0.2 0.1-0.1 0.1-0.3v-2.5h1.5v3h3.1v1.3h-3.1v5.8q0 0.8 0.3 1.3 0.4 0.4 1.2 0.4h1.5v1.4h-1.6q-1.4 0-2.2-0.8-0.8-0.8-0.8-2.3v-5.8z"
            />
            <path
              className="cat-face-outline"
              d="m160.3 88.2q-0.4-0.4-0.4-0.8 0-0.5 0.4-0.8 0.3-0.3 0.8-0.3 0.4 0 0.8 0.3 0.3 0.3 0.3 0.8 0 0.5-0.3 0.8-0.4 0.3-0.8 0.3-0.5 0-0.8-0.3zm0 7.6q-0.4-0.3-0.4-0.8 0-0.5 0.4-0.8 0.3-0.3 0.8-0.3 0.4 0 0.8 0.3 0.3 0.3 0.3 0.8 0 0.5-0.3 0.8-0.4 0.3-0.8 0.3-0.5 0-0.8-0.3z"
            />
            <path
              className="cat-face-outline"
              d="m171 90.9v-8.8h1.6v8.8q0 1.8 0.9 2.8 0.9 1 2.6 1 1.7 0 2.6-1 1-1 1-2.8v-8.8h1.5v8.8q0 2.4-1.3 3.8-1.4 1.4-3.8 1.4-2.4 0-3.8-1.4-1.3-1.4-1.3-3.8z"
            />
            <path
              fillRule="evenodd"
              className="cat-face-outline"
              d="m185 95.9v-13.8h4.6q2.1 0 3.3 1.1 1.2 1.2 1.2 3 0 1.5-0.8 2.5-0.9 1.1-2.1 1.5l3.2 5.7h-1.8l-3-5.6h-3v5.6zm1.5-7h3.1q1.3 0 2-0.7 0.8-0.7 0.8-2 0-1.2-0.7-1.9-0.8-0.8-2.2-0.8h-3z"
            />
            <path
              className="cat-face-outline"
              d="m196.3 89q0-1.5 0.5-2.8 0.6-1.3 1.5-2.3 0.9-0.9 2.2-1.5 1.4-0.5 2.9-0.5 2.3 0 4 1.2 1.7 1.2 2.4 3.2h-1.7q-0.6-1.3-1.8-2.1-1.2-0.8-2.9-0.8-1.6 0-2.9 0.7-1.2 0.7-1.9 2-0.7 1.3-0.7 2.9 0 1.6 0.7 2.9 0.7 1.3 2 2 1.2 0.7 2.8 0.7 1.4 0 2.5-0.5 1.2-0.6 1.9-1.6 0.7-1.1 0.7-2.4h-5.6v-1.5h7.4q0 0.1 0 0.1 0 1.4-0.4 2.6-0.3 1.3-1 2.1-0.6 0.9-1.5 1.5-0.8 0.6-1.9 0.9-1 0.3-2.1 0.3-1.2 0-2.3-0.3-1.1-0.4-2-1-0.8-0.7-1.5-1.5-0.6-0.9-1-2-0.3-1.1-0.3-2.3z"
            />
            <path
              className="cat-face-outline"
              d="m213.2 95.9v-13.8h1.7l7.2 11h0.1v-11h1.5v13.8h-1.6l-7.2-11h-0.1v11z"
            />
            <path className="cat-face-outline" d="m226.3 83.6v-1.5h10v1.5h-4.2v12.3h-1.6v-12.3z" />
            <path
              className="cat-face-outline"
              d="m239.2 95.8q-0.4-0.3-0.4-0.8 0-0.5 0.4-0.8 0.3-0.3 0.8-0.3 0.4 0 0.8 0.3 0.3 0.3 0.3 0.8 0 0.5-0.3 0.8-0.4 0.3-0.8 0.3-0.5 0-0.8-0.3zm-0.1-8.3v-5.4h1.7v5.4l-0.4 4.9h-0.9z"
            />
            <path
              className="cat-face-outline"
              d="m244.8 85.4v-1.3q1.8 0 2.6-0.5 0.8-0.4 0.8-1.5h1.5v13.8h-1.6v-10.5z"
            />
            <path
              className="cat-face-outline"
              d="m254.2 95.8q-0.4-0.3-0.4-0.8 0-0.5 0.4-0.8 0.3-0.3 0.8-0.3 0.4 0 0.7 0.3 0.4 0.3 0.4 0.8 0 0.5-0.4 0.8-0.3 0.3-0.7 0.3-0.5 0-0.8-0.3zm-0.1-8.3v-5.4h1.7v5.4l-0.4 4.9h-0.9z"
            />
            <path
              className="cat-face-outline"
              d="m260.3 95.8q-0.3-0.3-0.3-0.8 0-0.5 0.3-0.8 0.4-0.3 0.8-0.3 0.5 0 0.8 0.3 0.3 0.3 0.3 0.8 0 0.5-0.3 0.8-0.3 0.3-0.8 0.3-0.4 0-0.8-0.3zm0-8.3v-5.4h1.6v5.4l-0.3 4.9h-1z"
            />
            <path
              className="cat-face-outline"
              d="m266.5 95.8q-0.4-0.3-0.4-0.8 0-0.5 0.4-0.8 0.3-0.3 0.7-0.3 0.5 0 0.8 0.3 0.4 0.3 0.4 0.8 0 0.5-0.4 0.8-0.3 0.3-0.8 0.3-0.4 0-0.7-0.3zm-0.1-8.3v-5.4h1.7v5.4l-0.4 4.9h-1z"
            />
          </g>
          <g>
            <path
              ...
              d="m86.7 144.8v-15.2h4.9q2.2 0 3.4 1.1 1.2 1.1 1.2 2.8 0 1.1-0.5 2-0.5 0.8-1.4 1.3v0.1q0.4 0.2 0.8 0.4 0.4 0.3 0.8 0.7 0.4 0.5 0.6 1.1 0.2 0.6 0.2 1.4 0 1.3-0.6 2.3-0.7 1-1.7 1.5-1.1 0.5-2.3 0.5zm1.7-8.6h3.1q1.3 0 2-0.7 0.8-0.7 0.8-1.8 0-1.2-0.7-1.8-0.8-0.7-2.1-0.7h-3.1zm0 7.1h3.3q1.4 0 2.3-0.7 0.8-0.8 0.8-2.2 0-1.4-0.9-2.1-1-0.7-2.4-0.7h-3.1z"
            />
            <path
              className="phoebe-base-shade"
              d="m97.8 129.6h1.9l4.4 7.6h0.2l4.3-7.6h2l-5.5 9.4v5.8h-1.8v-5.8z"
            />
            <path
              className="phoebe-base-shade"
              d="m119.3 144.8v-15.2h2l5.8 13.3h0.2l5.4-13.3h1.9v15.2h-1.7v-11.3h-0.1l-4.6 11.3h-2l-5-11.3h-0.2v11.3z"
            />
            <path
              fillRule="evenodd"
              className="phoebe-base-shade"
              d="m137.9 137.2q0-1.6 0.6-3.1 0.6-1.4 1.6-2.5 1-1 2.5-1.6 1.4-0.6 3.1-0.6 1.7 0 3.1 0.6 1.5 0.6 2.5 1.6 1.1 1.1 1.7 2.5 0.6 1.5 0.6 3.1 0 1.7-0.6 3.1-0.6 1.5-1.7 2.5-1 1.1-2.5 1.7-1.4 0.6-3.1 0.6-1.3 0-2.6-0.4-1.2-0.4-2.1-1.1-1-0.7-1.7-1.7-0.7-0.9-1.1-2.1-0.3-1.2-0.3-2.6zm1.8 0q0 1.4 0.4 2.5 0.5 1.2 1.3 2 0.8 0.8 1.9 1.3 1.1 0.4 2.4 0.4 2.6 0 4.3-1.7 1.7-1.8 1.7-4.5 0-1.7-0.7-3.2-0.8-1.4-2.2-2.2-1.4-0.8-3.1-0.8-1.7 0-3.1 0.8-1.4 0.8-2.1 2.2-0.8 1.5-0.8 3.2z"
            />
            <path
              fillRule="evenodd"
              className="phoebe-base-shade"
              d="m154.6 144.8l5.9-15.2h2l5.9 15.2h-1.9l-1.3-3.6h-7.4l-1.3 3.6zm3.8-5.2h6.1l-3-7.9h-0.1z"
            />
            <path
              fillRule="evenodd"
              className="phoebe-base-shade"
              d="m171 144.8v-15.2h5.1q2.3 0 3.6 1.3 1.3 1.2 1.3 3.2 0 1.6-0.9 2.8-0.9 1.2-2.2 1.6l3.5 6.3h-2l-3.4-6.1h-3.3v6.1zm1.8-7.7h3.4q1.3 0 2.2-0.8 0.9-0.7 0.9-2.2 0-1.2-0.9-2.1-0.8-0.8-2.3-0.8h-3.3z"
            />
            <path
              className="phoebe-base-shade"
              d="m189.1 131.2v-1.6h11.1v1.6h-4.7v13.6h-1.7v-13.6z"
            />
            <path
              fillRule="evenodd"
              className="phoebe-base-shade"
              d="m203 144.8v-15.2h5.1q2.3 0 3.6 1.3 1.4 1.2 1.4 3.2 0 1.6-1 2.8-0.9 1.2-2.2 1.6l3.5 6.3h-2l-3.4-6.1h-3.3v6.1zm1.8-7.7h3.4q1.4 0 2.2-0.8 0.9-0.7 0.9-2.2 0-1.2-0.9-2.1-0.8-0.8-2.3-0.8h-3.3z"
            />
            <path
              className="phoebe-base-shade"
              d="m216.6 144.8v-15.2h8.6v1.6h-6.9v5.1h6v1.6h-6v5.3h7.2v1.6z"
            />
            <path
              className="phoebe-base-shade"
              d="m228.7 144.8v-15.2h8.7v1.6h-6.9v5.1h5.9v1.6h-5.9v5.3h7.1v1.6z"
            />
            <path
              className="phoebe-base-shade"
              d="m239.3 131.2v-1.6h11.1v1.6h-4.7v13.6h-1.7v-13.6z"
            />
            <path
              className="phoebe-base-shade"
              d="m252.1 144.8v-1.7l9.2-11.8v-0.1h-8.9v-1.6h10.9v1.7l-9.2 11.8v0.1h9.2v1.6z"
            />
          </g>
        </g>
        <g>
          <path
            ...
            d="m533.3 272.5c-43.8-47-38.3-63.5-38.3-63.5l-0.1 0.1q0 0 0 0 0.1-2 0.1-4.1c0-34.4-27.8-62.2-62.2-62.2-34.4 0-62.3 27.8-62.3 62.2 0 24.7 14.4 46 35.3 56.1q0 0-0.1 0c5.7 15.8 11.4 38.2 12.8 65.9 2.4 45-8.1 70.3-13 79.5l9.8 25h161.2v13.8h45.1c10.7-68.6-45.2-126.5-88.3-172.8z"
          />
          <path
            className="phoebe-highlight-fill"
            d="m470.6 408.6c-6.9-12.3-22.3-13.6-32.3-13-16.9 15.7-16.3 30.7-15.4 35.9h32.3c3.2-12.2 8.5-18.4 15.4-22.9z"
          />
          <path
            className="phoebe-ears-fill"
            d="m495 205q0 2.9-0.2 5.6c2.6-7.9 6-25.4 4.8-42.2-1.5-21-24-68.3-34.1-68-8.5 0.3-26.3 31.9-31.9 42.4 34 0.4 61.4 28.1 61.4 62.2z"
          />
          <path
            className="phoebe-ears-fill"
            d="m419.5 144.2c-12.8-5.8-62.5-27.7-69.7-18.6-7.4 9.3 16 59.2 21.4 70.4 3.7-25.7 23.2-46.3 48.3-51.8z"
          />
          <path className="phoebe-highlight-outline" d="m447.8 417c0 0-3.9 3.1-4.4 14.5" />
          <path className="phoebe-highlight-outline" d="m434.7 416.4c0 0-3.9 5.6-3.2 15.1" />
          <path
            className="phoebe-highlight-fill"
            d="m437.2 318.5c-8.5 1.4-15-1.8-20-7.1-2.3-20.6-6.9-37.6-11.5-50.3 0.1 0 0 0 0 0-8.7-4.2-16.3-10.4-22.2-18 1.2-14.5 5.6-43.2 22.6-43.2 22.2 0 13.4 36 48.6 62.9q0.1 0.1 0.3 0.2 0 0.1 0 0.2c2.1 8.9 9 50.9-17.8 55.3z"
          />
          <path
            className="phoebe-base-outline"
            d="m455.2 431.5c6.6-25.2 22.5-25.1 41.8-36.5 20-11.7 22.5-41.5 22.5-41.5"
          />
          <path
            className="phoebe-base-outline"
            d="m482.3 323.9c0 0 6.3 15.7-2.2 34.7-8.5 19-14 13.7-38.6 34.2-20.2 16.7-19.5 33.2-18.6 38.7"
          />
          <path
            className="phoebe-base-shade"
            d="m495 205q0 2.9-0.2 5.6c2.6-7.9 6-25.4 4.8-42.2-1.5-21-24-68.3-34.1-68q-0.6 0.1-1.2 0.3l13.5 61.3c10.7 11.2 17.2 26.3 17.2 43z"
          />
          <path
            className="phoebe-base-shade"
            d="m419.5 144.2c-12.8-5.8-62.5-27.7-69.7-18.6q-0.6 0.8-0.9 1.9l44.9 29c7.4-5.9 16.1-10.2 25.7-12.3z"
          />
          <g>
            <path className="cat-face-outline" d="m405.3 219.1c0.4 10.6 10.3 11.4 14.5 6.8" />
            <path className="cat-face-outline" d="m405.3 219.1c-0.4 10.6-10.3 11.4-14.4 6.8" />
          </g>
          <path className="cat-face-outline" d="m418 199.9c0-3.9 3.1-7 7-7 3.9 0 7 3.1 7 7" />
          <path className="cat-face-outline" d="m380.7 199.9c0-3.9 3.1-7 7-7 3.9 0 7 3.1 7 7" />
          <path
            className="phoebe-base-outline"
            d="m560.8 377.5c0 0-23.3 1.8-35.5 25.8-6.7 13-8.7 22.4-9.1 28.2"
          />
          <path
            className="phoebe-base-fill"
            d="m646.4 446.3q0.3-0.3 0.3-0.3l0.7 0.7h31.3c6.6-19.2 8.6-52.8-16.3-106-27.2-58.1 0.5-92.5 9.6-101.6 5.7-5.6 5.7-14.8 0-20.5-5.6-5.7-14.8-5.7-20.5 0-25.7 25.8-43.3 74.6-15.3 134.4 32.4 69.4 10.4 93.1 10.2 93.3z"
          />
          <path
            className="phoebe-highlight-shade"
            d="m427.6 267q-0.9 0-1.8-0.1-1.1-0.1-2.1-0.3-0.7-0.1-1.3-0.2-1.2-0.2-2.4-0.5-0.5-0.1-0.9-0.1-1.3-0.3-2.6-0.7-0.3-0.1-0.7-0.2-1.3-0.4-2.6-0.8-0.3-0.1-0.6-0.2-1.3-0.4-2.6-1-0.3 0-0.5-0.1-1.3-0.6-2.6-1.2-0.1 0-0.3-0.1l-0.8-0.4q0 0-0.1 0c1.5 4.1 3 8.7 4.4 13.7q0 0 0 0c3.5 4.6 9.1 8.5 18.2 7.4 15.8-2 24.2-14.2 26.9-19.1q-3.9 1.5-8 2.5-0.1 0-0.1 0-1.3 0.3-2.7 0.6-0.2 0-0.3 0-1.3 0.3-2.5 0.5-0.4 0-0.7 0-1.1 0.2-2.2 0.3-0.6 0.1-1.3 0.1-0.8 0.1-1.6 0.1-1.5 0.1-3 0.1-1.8 0-3.5-0.1-0.9-0.1-1.7-0.2z"
          />
          <path
            className="phoebe-base-shade"
            d="m405.2 209.7q0 0 0 0 0 0 0 0c-6.2 0-9.8 1.3-5.1 6.6 3.3 3.7 4.8 4.5 5.1 4.6q0 0 0 0 0.1 0 0.1 0c0.3-0.2 1.8-0.9 5-4.6 4.6-5.4 1.1-6.7-5.1-6.6z"
          />
        </g>
        <g>
          <path className="alecia-laptop-shade" d="m406.7 445.3l-78.3-203.3h-328.3l81.1 203.3z" />
          <g>
            <path
              className="alecia-laptop-highlight"
              d="m198.7 369.9l-26.2-17.5v-17.5l26.2 17.5 26.3-17.5v17.5z"
            />
            <path
              className="alecia-laptop-highlight"
              d="m198.7 334.9l-6.5 4.4-13.2-8.7 19.7-13.2 19.7 13.2-13.1 8.7z"
            />
          </g>
          <g>
            <path
              className="alecia-laptop-edge"
              d="m406.7 445.3l-78.3-203.3h-328.3l14.1-9.7h322.8l78.4 199.2z"
            />
            <path className="alecia-laptop-edge" d="m406.6 445.3h169.9v-13.8h-161.2z" />
          </g>
        </g>
        <g id="phoebe-laptop-desk">
          <path
            className="desktop"
            d="m696.4 471.3h-657.5c-7.2 0-13-5.8-13-13 0-7.2 5.8-13 13-13h657.5c7.2 0 13 5.8 13 13 0 7.2-5.8 13-13 13z"
          />
        </g>
      </g>
      <g id="light-phoebe-laptop">
        <use
          href="#phoebe-laptop-logo-light"
          className="svg-light"
          transform="matrix(1,0,0,1,125.669,272.352)"
        />
        <path
          className="phoebe-laptop-light svg-light"
          d="m14.2 232.3h322.9l78.3 199.2h161.2l-0.1 13.8c8-11.6 139.2-99.4 3.2-340-76.2-134.7-272.7-126.7-272.7-126.7z"
        />
      </g>
    </g>
  </svg>
