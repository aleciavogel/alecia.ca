    ...
    <g id="phoebe-laptop-svg">
      <g id="dark illustration">
        <g>
          ...
          <g>
            <path
              className="cat-face-outline fill-black"
              d="m85.1 60v-1.4h10v1.4h-4.2v12.3h-1.6v-12.3z"
            />
            <path
              fillRule="evenodd"
              className="cat-face-outline fill-black"
            ...
            <path
              className="cat-face-outline fill-black"
              d="m226.3 83.6v-1.5h10v1.5h-4.2v12.3h-1.6v-12.3z"
            />
            <path
              className="cat-face-outline fill-black"
