...
// Query: *[ _type == 'blog.article' ] | order(publishDate desc) {    title,    'description': previewText,    'url': 'https://alecia.ca/blog/' + metadata.slug.current,    'tags': categories[]-> {      title    }.title,    'date': publishDate,}
