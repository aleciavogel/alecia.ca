...
import HappyLittleBracketsSvg from '@/features/_layout/header/components/HappyLittleBracketsSvg'
import StaticNavListItem from './StaticNavListItem'
import { faRocketLaunch } from '@fortawesome/pro-solid-svg-icons'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import TeleportAnimation from '@/features/_layout/header/components/TeleportAnimation'
...
const LearnToCodeDropdownContent: FC = () => {
  ...
  return (
    <>
      ...
      <StaticNavListItem href="/learn-to-code/coding-101" title="Coding 101">
