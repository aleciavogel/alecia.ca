...
export const TOPICS: Record<Tech, TutorialStackItem> = {
  [Tech.PHOENIX]: {
    ...
    type: 'fullstack',
    image: '/img/tutorials/phoenix.png',
  },
  [Tech.ELIXIR]: {
    name: 'Elixir',
    description:
    ...
    type: 'backend',
    image: '/img/tutorials/elixir.png',
  },
  [Tech.TAILWIND]: {
    name: 'Tailwind CSS',
    ...
    type: 'frontend',
    image: '/img/tutorials/tailwind.png',
  },
  [Tech.REACT]: {
    name: 'React',
  ...
  [Tech.NEXTJS]: {
    ...
    type: 'frontend',
    image: '/img/tutorials/nextjs.png',
  },
  [Tech.TYPESCRIPT]: {
    name: 'TypeScript',
    ...
    type: 'frontend',
    image: '/img/tutorials/typescript.svg',
  },
  [Tech.JAVASCRIPT]: {
    name: 'JavaScript',
    description:
    ...
    type: 'frontend',
    image: '/img/tutorials/javascript.png',
  },
  [Tech.HTML]: {
    name: 'HTML',
    description:
  ...
  [Tech.POSTGRESQL]: {
    ...
    type: 'backend',
    image: '/img/tutorials/postgres.png',
  },
  [Tech.MYSQL]: {
    name: 'MySQL',
  ...
  [Tech.PYTHON]: {
    ...
    type: 'backend',
    image: '/img/tutorials/python.svg',
  },
}
