...
import AleciaLayingIllustration from '@alecia/common/graphics/illustrations/alecia/laying'
import {
  MenuSheetClose,
  MenuSheetContent,
  MenuSheetDescription,
  MenuSheetTitle,
} from '@alecia/common/ui/menu-sheet'
import SocialLink from '@alecia/common/ui/social-link'
import { FullScreenMenuType, SocialLinksType } from '@alecia/core/settings/types'
import { cn } from '@alecia/util/styles'

const LoopDeLoopText = dynamic(() => import('@alecia/core/animations/components/loop-de-loop-text'))
...
const FullscreenMenu = forwardRef<HTMLElement, FullscreenMenuProps>(
