import HammondSleepingIllustration from '@alecia/common/graphics/illustrations/hammond/sleeping'
import Typography from '@alecia/common/ui/typography'
import StickyNav from '@alecia/core/navigation/components/sticky-nav'
import { pageVariants } from '@alecia/core/pages/constants/page-variants'
