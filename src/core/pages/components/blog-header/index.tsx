...
import AleciaCouchIllustration from '@alecia/common/graphics/illustrations/alecia/couch'
...
const BlogHeader: FC<BlogHeaderProps> = ({ pretitle = 'Pretitle', title = 'Untitled' }) => {
  return (
    <header
      className={cn(
        'relative',
