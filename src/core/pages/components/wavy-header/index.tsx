...
import AleciaWaveIllustration from '@alecia/common/graphics/illustrations/alecia/wave'
...
const WavyText = dynamic(() => import('@alecia/core/animations/components/wavy-text'))
