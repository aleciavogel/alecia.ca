...
const AleciaLayingSvg: FC<Props> = (props) => {
  return (
    ...
    >
      <defs>
        <style>{`.clb-1,.clb-10,.clb-11,.clb-13,.clb-16,.clb-19,.clb-2,.clb-24,.clb-26,.clb-28,.clb-29,.clb-3,.clb-39,.clb-4,.clb-40,.clb-41,.clb-5,.clb-6,.clb-7,.clb-8,.clb-9{fill:none;}.clb-10,.clb-11,.clb-2,.clb-3,.clb-4,.clb-5,.clb-6,.clb-7,.clb-8,.clb-9{stroke:#510073;stroke-width:1.5px;}.clb-10,.clb-11,.clb-13,.clb-16,.clb-19,.clb-2,.clb-24,.clb-26,.clb-27,.clb-28,.clb-29,.clb-3,.clb-39,.clb-4,.clb-40,.clb-41,.clb-5,.clb-6,.clb-7,.clb-8,.clb-9{stroke - linecap:round;stroke-linejoin:round;}.clb-3{clip - path:url(#clip-path);}.clb-4{clip - path:url(#clip-path-10);}.clb-5{clip - path:url(#clip-path-3);}.clb-6{clip - path:url(#clip-path-4);}.clb-7{clip - path:url(#clip-path-5);}.clb-8{clip - path:url(#clip-path-6);}.clb-9{clip - path:url(#clip-path-7);}.clb-10{clip - path:url(#clip-path-8);}.clb-11{clip - path:url(#clip-path-9);}.clb-12{fill:#dccffe;}.clb-13{stroke:#c5b9ef;}.clb-13,.clb-16,.clb-19,.clb-24,.clb-28,.clb-39,.clb-40,.clb-41{stroke - width:2px;}.clb-14{fill:#5f75ff;}.clb-15{fill:#ee5da0;}.clb-16{stroke:#c6327c;}.clb-17{fill:#ae9ddd;}.clb-18{fill:#b7c1f9;}.clb-19{stroke:#1d3ba8;}.clb-20{fill:#666158;}.clb-21{fill:#e5e4eb;}.clb-22{fill:#8e8982;}.clb-23{fill:#f4f4f4;}.clb-24{stroke:#c7c7c9;}.clb-25,.clb-27{fill:#ffafaa;}.clb-26,.clb-27{stroke:#ffafaa;stroke-width:12px;}.clb-28{stroke:#c95757;}.clb-29{stroke:#fff;stroke-width:3px;}.clb-30{fill:#fff;}.clb-31{fill:#961091;}.clb-32{clip - path:url(#clip-path-11);}.clb-33{fill:#011230;}.clb-34{fill:#7f0989;}.clb-35{fill:#c95757;}.clb-36{fill:#8c7a7a;}.clb-37{fill:#755a54;}.clb-38{fill:#ffd0bc;}.clb-39{stroke:#000;}.clb-40{stroke:#daaa93;}.clb-41{stroke:#544747;}.clb-42{fill:#54423e;}.clb-43{fill:url(#Безымянный_градиент_52);}`}</style>
        ...
        <clipPath id="clip-path-3">
          <path className="clb-2" d="M886.05,228.33c-11.5,13.77-71.25-7.41-68.75-27.41" />
        </clipPath>
      ...
      <g id="Layer_2" data-name="Layer 2">
        <g id="illustration_night" data-name="illustration night">
          ...
          />
          <line className="clb-13" x1="151.12" y1="387.29" x2="150.21" y2="402.84" />
          <path
            className="clb-14"
          ...
          />
          <path className="clb-16" d="M623.3,264.54s28.25,8.88,42.25,23.13" />
          <path
            className="clb-17"
          ...
          />
          <line className="clb-19" x1="209.8" y1="194.17" x2="216.4" y2="223.37" />
          <polyline className="clb-19" points="182.22 341.63 216.11 222.11 249.24 350.32" />
          <path
            className="clb-13"
            d="M981.89,323c-7.84-12.87-29.8-16.95-67.17-5.84-74.54,22.16-130,96.13-124.92,113.68"
          />
          <path className="clb-19" d="M223.39,110.35s32-4.27,76.37,61.22" />
          <polygon
            className="clb-20"
          ...
          />
          <line className="clb-24" x1="298.17" y1="316.95" x2="381.19" y2="233.46" />
          <path
            className="clb-25"
          ...
          />
          <path className="clb-26" d="M413.43,260s20.37,14.13,13.92,33.54" />
          <path className="clb-27" d="M375,250.67c17.12,1.91,34.41,13.35,37.08,26.37" />
          <path className="clb-27" d="M363.63,256.68c14.38-.4,38.25,11.06,39.09,28.49" />
          <path className="clb-27" d="M358,264.67c10.66-1.25,36.75,13.69,36.75,24.33" />
          <path className="clb-27" d="M356.05,273.33s25.21,7.17,25.21,19.67" />
          <path
            className="clb-15"
          ...
          />
          <path className="clb-28" d="M408.36,259.36a55.61,55.61,0,0,1,10.6,14" />
          <path className="clb-28" d="M369.64,251a52.15,52.15,0,0,1,30.62,15.29" />
          <path className="clb-28" d="M358.16,258.41c12.42-.11,26.1,7.84,33.58,15" />
          <path className="clb-28" d="M353.84,268.19c4.77-1.67,22.12,5,29.34,14" />
          <path
            className="clb-31"
          ...
          <g className="clb-32">
            <path className="clb-2" d="M886.05,228.33c-11.5,13.77-71.25-7.41-68.75-27.41" />
            <path className="clb-2" d="M816.55,210.79c0,18.06,58.83,35.17,69.75,15.36" />
            <path className="clb-2" d="M815.93,218.42c-2.75,13.75,34.56,50.75,70.75,29.5" />
            <path className="clb-2" d="M811.68,227.79c-1.75,24.35,50.2,47.54,74.12,19.13" />
            <path className="clb-2" d="M804.76,254.67c-9.48,17.5,51.29,37.75,70.29,14" />
            <path className="clb-2" d="M884.43,262.67c6.29,31.5-43.89,57.68-66.88,28.75" />
            <path className="clb-2" d="M813.8,197.17c8.75-13.64,55.38-4.88,67.75,25.5" />
            <path className="clb-2" d="M772.43,188.42c-1.88-2.38-9.66-16.77,16.62-21.86" />
            <path className="clb-2" d="M807.93,190.77c-2.13-10.23,42.25-30.63,75,25.65" />
            <path className="clb-2" d="M799.3,190.77c-4.25-9.26,4.5-23,43-18.1" />
            <path className="clb-2" d="M786.3,186s0-21.75,42-18.87" />
            <path className="clb-2" d="M781.1,190.77c-5.05-7.24,0-26.48,25.95-26.48" />
          </g>
          <path
            className="clb-31"
          ...
          />
          <path className="clb-2" d="M934.22,210.79s32.66-1.37,31.16,53.75" />
          <path
            className="clb-2"
            d="M890.72,227s20.38-24.14,49.33.79c22.5,19.38,10.5,43.36,28.75,58.44"
          />
          <path className="clb-2" d="M892.22,233.29c31.5-24.29,50.77,9.14,55.27,26" />
          <path
            className="clb-33"
          ...
          />
          <path className="clb-28" d="M736.35,251c1.72,2.62,1.95,4.37,1,6.82" />
          <path className="clb-28" d="M737.71,254s-11.42,4-14.88-8.08" />
          <path
            className="clb-28"
          ...
          <circle className="clb-33" cx="806.45" cy="317.11" r="7.14" />
          <ellipse
            className="clb-34"
            cx="765.12"
            cy="194.69"
          ...
          <path className="clb-39" d="M664.72,159.58c-1.42,6,7.79,7.8,10.85-.51" />
          <path d="M672.8,155.17c-.83,1.52,2.71,5.41,4.09,5.29,1.82-.16,3.51-4.45,1.91-5.26C677.37,154.48,673.91,153.12,672.8,155.17Z" />
          <path className="clb-38" d="M666.32,111.8l.61-23L649.61,118.5S657.38,112,666.32,111.8Z" />
          ...
          />
          <path className="clb-40" d="M625.05,304.92s6.75-.59,6.75,10.08" />
          <path className="clb-40" d="M642.3,300.5s6.47,0,6.05,10.87" />
          <path className="clb-41" d="M542.56,249.11c7.66-2.5,38.11,5,18.62,45.63" />
          <line className="clb-41" x1="591.38" y1="234.83" x2="600.22" y2="277.11" />
          <path
            className="clb-38"
          ...
          />
          <path className="clb-40" d="M579.55,303.79s8.93-.25,6.93,11" />
          <path
            className="clb-42"
          ...
          />
          <path className="clb-42" d="M623,255.05s-1.3,6.21-14.35,6.46c0,0,5.35,5.73,14.69,1.4Z" />
          <path className="clb-42" d="M592.71,241s1.84,7.62,20.28,6.06c0,0-6.81,8.75-18.43,2.81Z" />
          <path className="clb-40" d="M623.94,263.21l.44,32.79s17.09.62,16.64,15.37" />
          <path
