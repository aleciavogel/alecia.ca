...
export default function BrandsSection() {
  return (
    <View style={[styles.section]}>
      <Text style={tw("text-base mt-2")}>Brands I've Worked With</Text>
      <View style={tw("flex flex-row flex-wrap justify-between items-center")}>
        <Image src="/brands/aheia.jpeg" style={[tw("pr-4 mb-10 w-1/6")]} />
        <Image src="/brands/ahs.png" style={[tw("pr-4 w-1/6")]} />
        <Image src="/brands/albertagov.png" style={[tw("pr-4 w-1/6")]} />
        <Image src="/brands/albertainnovates.png" style={[tw("pr-4 w-1/6")]} />
        ...
        <Image src="/brands/edmonton_elks.png" style={[tw("pr-4 mb-4 w-1/6")]} />
