import type { TutorialStackItem, Tutorial } from '@/types/tutorials.d'
import { TutorialTech as Tech, TutorialLevel } from '@/types/tutorials.d'
...
export const Tutorials: Record<string, Tutorial> = {
  'jackbox-clone-supabase-nextjs': {
    title: 'Build A Jackbox Clone with Supabase & NextJS',
